...
def test_scan_projects(godot3_dir: Path, project_name: str, expected_script_count: int, expected_scene_count: int) -> None:
...
def test_invalid_projects(godot3_dir: Path, project_name: str, expected_error_type: str, expected_error_message: str) -> None:
    project_path: Path = godot3_dir / project_name
